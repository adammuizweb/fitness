...
const en: TranslationSet = {
  ...
  'workoutList.filterDeleted': 'Trash',
  ...
  'workoutList.deleted': 'Deleted',
  'workoutList.restore': 'Restore workout',
  'workoutListDelete.title': 'Delete Workout',
  'workoutListDelete.desc': 'This workout will be moved to Trash. Its schedules and workout logs will remain saved, and you can restore it later.',
  'dangerZone.title': 'Workout Status',
  'dangerZone.desc': 'Hide removes the workout from your daily schedule. Delete moves it to Trash. Both actions preserve schedules and workout logs.',
  'dangerZone.deactivate': 'Deactivate',
  'dangerZone.activate': 'Activate',
  'dangerZone.delete': 'Delete',
  'dangerZone.deleteDialogTitle': 'Delete Workout',
  'dangerZone.deleteDialogDesc': 'Delete "{name}"? It will be moved to Trash and its workout history will remain saved.',
  ...
  'log.otherWorkout': 'Other Workout',
  'log.otherWorkoutDesc': 'Add an active workout from another day to today\'s checklist.',
  'log.otherWorkoutSearch': 'Search active workouts...',
  'log.otherWorkoutHint': 'Search for a workout you want to do today.',
  'log.otherWorkoutEmpty': 'No matching active workout found.',
  'log.otherWorkoutAdd': 'Add',
  'log.sets': 'Sets',
  'log.reps': 'Reps',
  'log.weight': 'Kg',
  ...
  'log.cardio': 'Cardio',
  'log.lift': 'Lifting',
  'log.customActivity': 'Custom Activity',
  'log.customActivityDesc': 'Log any non-workout activity (hiking, swimming, etc.) — still counts toward your streak',
  'log.customActivityPlaceholder': 'e.g. Hiking Mount Everest',
  'log.customActivityLog': 'Create Custom Activity',
  'log.photo': 'Photo',
  'log.photos': 'photos',
  'log.addPhoto': 'Add Photo',
  'log.addMore': 'Add More',
  'log.managePhotos': 'Manage',
  'log.deleteActivityTitle': 'Delete Custom Activity',
  'log.deleteActivityConfirm': 'Are you sure you want to delete this activity?',
  'log.deleteActivitySharedWarning': 'This activity has been shared in your posts.',
  'log.deleteActivitySharedHint': 'If you delete it, the workout details will be removed from those posts. The posts themselves (photos and caption) will remain.',
...
const id: TranslationSet = {
  ...
  'workoutList.filterDeleted': 'Sampah',
  ...
  'workoutList.deleted': 'Dihapus',
  'workoutList.restore': 'Pulihkan workout',
  'workoutListDelete.title': 'Hapus Workout',
  'workoutListDelete.desc': 'Workout akan dipindahkan ke Sampah. Jadwal dan log workout tetap tersimpan dan dapat dipulihkan kembali.',
  'dangerZone.title': 'Status Workout',
  'dangerZone.desc': 'Hide menyembunyikan workout dari jadwal harian. Hapus memindahkannya ke Sampah. Kedua aksi tetap menyimpan jadwal dan log workout.',
  'dangerZone.deactivate': 'Nonaktifkan',
  'dangerZone.activate': 'Aktifkan',
  'dangerZone.delete': 'Hapus',
  'dangerZone.deleteDialogTitle': 'Hapus Workout',
  'dangerZone.deleteDialogDesc': 'Hapus "{name}"? Workout akan dipindahkan ke Sampah dan seluruh riwayatnya tetap tersimpan.',
  ...
  'log.otherWorkout': 'Workout Lain',
  'log.otherWorkoutDesc': 'Tambahkan workout aktif dari hari lain ke checklist hari ini.',
  'log.otherWorkoutSearch': 'Cari workout aktif...',
  'log.otherWorkoutHint': 'Cari workout yang ingin kamu lakukan hari ini.',
  'log.otherWorkoutEmpty': 'Workout aktif yang sesuai tidak ditemukan.',
  'log.otherWorkoutAdd': 'Tambah',
  'log.sets': 'Sets',
  'log.reps': 'Reps',
  'log.weight': 'Kg',
  ...
  'log.customActivity': 'Aktivitas Kustom',
  'log.customActivityDesc': 'Catat aktivitas non-workout (hiking, renang, dll.) — tetap dihitung untuk streak',
  'log.customActivityPlaceholder': 'Contoh: Hiking Gunung Everest',
  'log.customActivityLog': 'Buat Aktivitas',
  'log.photo': 'Foto',
  'log.photos': 'foto',
  'log.addPhoto': 'Tambah Foto',
  'log.addMore': 'Tambah Lagi',
  'log.managePhotos': 'Atur',
  'log.deleteActivityTitle': 'Hapus Aktivitas Kustom',
  'log.deleteActivityConfirm': 'Apakah kamu yakin ingin menghapus aktivitas ini?',
  'log.deleteActivitySharedWarning': 'Aktivitas ini telah dibagikan ke postinganmu.',
  'log.deleteActivitySharedHint': 'Jika dihapus, detail workout akan hilang dari postingan tersebut. Postingan (foto dan caption) tetap ada.',
