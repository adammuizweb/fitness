...
const en: TranslationSet = {
  ...
  'workoutListDelete.desc': 'This workout will be moved to Inactive. Its schedules and workout logs will remain saved, and you can restore it later.',
  'dangerZone.title': 'Workout Status',
  'dangerZone.desc': 'Deleting moves this workout to Inactive without losing its schedules or logs. You can restore it later from the Inactive filter.',
  ...
  'dangerZone.deleteDialogDesc': 'Delete "{name}"? It will be moved to Inactive and its workout history will remain saved.',
...
const id: TranslationSet = {
  ...
  'workoutListDelete.desc': 'Workout akan dipindahkan ke Nonaktif. Jadwal dan log workout tetap tersimpan dan dapat dipulihkan kembali.',
  'dangerZone.title': 'Status Workout',
  'dangerZone.desc': 'Menghapus akan memindahkan workout ke Nonaktif tanpa menghapus jadwal atau log. Workout dapat dipulihkan melalui filter Nonaktif.',
  ...
  'dangerZone.deleteDialogDesc': 'Hapus "{name}"? Workout akan dipindahkan ke Nonaktif dan seluruh riwayatnya tetap tersimpan.',
