...
const en: TranslationSet = {
  ...
  'dangerZone.desc': 'Deactivate to hide this workout from the daily schedule without losing its logs. You can reactivate it later from the Inactive filter.',
...
const id: TranslationSet = {
  ...
  'dangerZone.desc': 'Nonaktifkan workout untuk menyembunyikannya dari jadwal harian tanpa menghapus log. Workout dapat diaktifkan kembali melalui filter Nonaktif.',
