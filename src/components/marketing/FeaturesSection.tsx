...
export function FeaturesSection() {
  ...
  const features: Feature[] = [
    ...
    { num: '04', icon: <Calendar className="w-5 h-5" />, title: t('landing.features.scheduleTitle'), desc: t('landing.features.scheduleDesc'), detail: 'Assign workouts to specific days of the week. Your daily checklist updates automatically. Mark rest days and let the app auto-complete them so recovery counts toward your streak.', screenshot: '/screenshots/schedule.png' },
    { num: '05', icon: <Camera className="w-5 h-5" />, title: t('landing.features.photosTitle'), desc: t('landing.features.photosDesc'), detail: 'Take or upload photos directly from your phone during workouts. Images are automatically compressed to WebP format (≤300KB) and stored securely on our private CDN.', screenshot: '/screenshots/photos_feature.png' },
    { num: '06', icon: <Lock className="w-5 h-5" />, title: t('landing.features.privacyTitle'), desc: t('landing.features.privacyDesc'), detail: 'Full privacy control. Set your profile to public or private. Each post has its own audience selector: Only Me, Followers, Friends (mutual follows), or Everyone. Private profiles are completely invisible.', screenshot: '/screenshots/settings.png' },
