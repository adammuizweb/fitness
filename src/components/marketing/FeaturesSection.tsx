...
export function FeaturesSection() {
  ...
  const features: Feature[] = [
    { num: '01', icon: <Users className="w-5 h-5" />, title: t('landing.features.socialTitle'), desc: t('landing.features.socialDesc'), detail: 'Follow other members, share your workout activity, and engage with the community. Public profiles show your shared workouts and posts. Privacy controls let you choose who sees what.', screenshot: '/screenshots/profile.webp' },
    { num: '02', icon: <Share2 className="w-5 h-5" />, title: t('landing.features.shareTitle'), desc: t('landing.features.shareDesc'), detail: 'Share individual workout templates or your full weekly schedule plan. Other members can browse your shared content on your public profile and copy it instantly to their own workout list.', screenshot: '/screenshots/posts.webp' },
    { num: '03', icon: <Dumbbell className="w-5 h-5" />, title: t('landing.features.workoutTitle'), desc: t('landing.features.workoutDesc'), detail: 'Create custom workout templates for lifting or cardio. Set default sets, reps, weight, distance, and duration. Organize your routine and reuse them daily.', screenshot: '/screenshots/workouts.webp' },
    { num: '04', icon: <Calendar className="w-5 h-5" />, title: t('landing.features.scheduleTitle'), desc: t('landing.features.scheduleDesc'), detail: 'Assign workouts to specific days of the week. Your daily checklist updates automatically. Mark rest days and let the app auto-complete them so recovery counts toward your streak.', screenshot: '/screenshots/schedule.webp' },
    { num: '05', icon: <Camera className="w-5 h-5" />, title: t('landing.features.photosTitle'), desc: t('landing.features.photosDesc'), detail: 'Take or upload photos directly from your phone during workouts. Images are automatically compressed to WebP format (≤300KB) and stored securely on our private CDN.', screenshot: '/screenshots/photos_feature.webp' },
    { num: '06', icon: <Lock className="w-5 h-5" />, title: t('landing.features.privacyTitle'), desc: t('landing.features.privacyDesc'), detail: 'Full privacy control. Set your profile to public or private. Each post has its own audience selector: Only Me, Followers, Friends (mutual follows), or Everyone. Private profiles are completely invisible.', screenshot: '/screenshots/settings.webp' },
    { num: '07', icon: <CheckCircle2 className="w-5 h-5" />, title: t('landing.features.logTitle'), desc: t('landing.features.logDesc'), detail: 'Your daily workout checklist shows all scheduled exercises. Check them off, edit sets/reps inline, and add photos. If you already logged a workout on a rest day, the rest is skipped automatically.', screenshot: '/screenshots/log.webp' },
    { num: '08', icon: <Moon className="w-5 h-5" />, title: t('landing.features.restTitle'), desc: t('landing.features.restDesc'), detail: 'Designate specific days of the week as rest days. On those days, the checklist auto-completes so you can focus on recovery. If you already worked out, rest day is skipped.', screenshot: '/screenshots/rest_days.webp' },
    { num: '09', icon: <Flame className="w-5 h-5" />, title: t('landing.features.streakTitle'), desc: t('landing.features.streakDesc'), detail: 'GitHub-style activity calendar showing your daily consistency. Current and longest streaks are displayed prominently. Stay motivated by watching your streak grow day by day.', screenshot: '/screenshots/streak.webp' },
    { num: '10', icon: <Languages className="w-5 h-5" />, title: t('landing.features.i18nTitle'), desc: t('landing.features.i18nDesc'), detail: 'The entire interface is available in English and Indonesian. Switch anytime from the settings page. Your language preference is remembered across sessions.', screenshot: '/screenshots/language.webp' },
    { num: '11', icon: <Shield className="w-5 h-5" />, title: t('landing.features.adminTitle'), desc: t('landing.features.adminDesc'), detail: 'Full admin dashboard for managing users, viewing platform statistics, and controlling settings. Ban/unban users, change roles, and monitor usage metrics in real-time.', screenshot: '/screenshots/admin.webp' },
  ]
