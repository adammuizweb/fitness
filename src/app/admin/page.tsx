  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Panel administrasi Fitnes Tracker</p>
      </div>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Lihat, edit, ban user</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Data penggunaan aplikasi</p>
              </div>
            </CardContent>
          </Card>
        </Link>
